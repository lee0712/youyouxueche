...
@implementation PingceTableViewCell
...
- (void)initWithSubViews
{
    ...
    // 详情
    _detailLabel = [[UILabel alloc] initWithFrame:CGRectMake(screen_width-70, _userImageView.frame.size.height + _userImageView.frame.origin.y-20, 80, 20)];
