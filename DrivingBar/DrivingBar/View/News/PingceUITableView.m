...
#import "MJRefresh.h"
#import "public.h"
#import "PingceTableViewCell.h"
#import "AFNetworking.h"

@interface PingceUITableView ()<UITableViewDelegate, UITableViewDataSource>
{
    long totalRow;
    long nowPage;
    BOOL ifFull;
...
@implementation PingceUITableView
...
- (void)getData {
    [self reloadData];
    ifFull = NO;
    __weak PingceUITableView *weakSelf = self;
    totalRow=0;
    nowPage = 1;
...
- (UITableViewCell *)tableView:(UITableView *)tableView cellForRowAtIndexPath:(NSIndexPath *)indexPath {
    ...
    PingceTableViewCell *cell = [self dequeueReusableCellWithIdentifier:identifier];
    
    if (cell == nil)
        cell = [[PingceTableViewCell alloc] initWithStyle:UITableViewCellStyleSubtitle reuseIdentifier:identifier];
