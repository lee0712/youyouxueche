...
#import "MJRefresh.h"
#import "public.h"
#import "HangqingTableViewCell.h"
#import "AFNetworking.h"

@interface HangqingUITableView ()<UITableViewDelegate, UITableViewDataSource>
{
    long totalRow;
    long nowPage;
    BOOL ifFull;
...
@implementation HangqingUITableView
...
- (void)getData {
    [self reloadData];
    ifFull = NO;
    __weak HangqingUITableView *weakSelf = self;
    totalRow=0;
    nowPage = 1;
...
- (UITableViewCell *)tableView:(UITableView *)tableView cellForRowAtIndexPath:(NSIndexPath *)indexPath {
    static NSString *identifier = @"pingceCell";
    HangqingTableViewCell *cell = [self dequeueReusableCellWithIdentifier:identifier];
    
    if (cell == nil)
        cell = [[HangqingTableViewCell alloc] initWithStyle:UITableViewCellStyleSubtitle reuseIdentifier:identifier];
