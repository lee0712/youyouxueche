...
- (id)initWithFrame:(CGRect)frame
{
    ...
    numValueLabel.text = [userDefaults objectForKey:@"k4v1"];;
    scoreValueLabel.text = [userDefaults objectForKey:@"k4v2"];
    perValueLabel.text =[userDefaults objectForKey:@"k4v3"];
