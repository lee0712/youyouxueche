...
- (id)initWithFrame:(CGRect)frame
{
    ...
    numValueLabel.text = [userDefaults objectForKey:@"k1v1"];;
    scoreValueLabel.text = [userDefaults objectForKey:@"k1v2"];
    perValueLabel.text =[userDefaults objectForKey:@"k1v3"];
